<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"D:\www\tp5cms\public/../application/admin\view\carticle\add.html";i:1544107605;s:55:"D:\www\tp5cms\application\admin\view\common\header.html";i:1543226272;s:53:"D:\www\tp5cms\application\admin\view\common\left.html";i:1544106706;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div id="sidebar-left" class="span2">
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> 文章管理</span></a>
							<ul style="display: block;">
								<li><a class="submenu" href="/index.php/admin/Carticle/show"><i class="icon-hdd"></i><span class="hidden-tablet">文章列表</span></a></li>								
								<li><a class="submenu" href="<?php echo url('Carticle/add'); ?>"><i class="icon-hdd"></i><span class="hidden-tablet"> 添加文章</span></a></li>								
							</ul>	
						</li>
			...
			<div id="content" class="span10">
				<div class="box span12">
					<div class="box-header">
						<h2><i class="icon-table"></i>添加文章</h2>
					</div>
					<div class="box-content">
						<form class="form-horizontal" action='tianjia' method='POST'>
							<fieldset>
								<div class="control-group">
									<label class="control-label" for="inputWarning">标　　题</label>
									<div class="controls">
							...
							<fieldset>
								<div class="control-group">
									<label class="control-label" for="selectError3">栏　　目</label>
									<div class="controls">
							...
							<fieldset>
								...
								<div class="controls">
								  <label class="checkbox inline">
									<div class="checker" id="uniform-inlineCheckbox1"><span><input type="checkbox" id="inlineCheckbox1" value="option1"></span></div> 头条[h]
								  </label>
								  <label class="checkbox inline">
									<div class="checker" id="uniform-inlineCheckbox2"><span><input type="checkbox" id="inlineCheckbox2" value="option2"></span></div> 推荐[c]
								  </label>
								  <label class="checkbox inline">
									<div class="checker" id="uniform-inlineCheckbox3"><span><input type="checkbox" id="inlineCheckbox3" value="option3"></span></div> 特荐[f]
								  </label>
								  <label class="checkbox inline">
									<div class="checker" id="uniform-inlineCheckbox1"><span><input type="checkbox" id="inlineCheckbox1" value="option1"></span></div> 加粗[b]
								  </label>
								  <label class="checkbox inline">
									<div class="checker" id="uniform-inlineCheckbox2"><span><input type="checkbox" id="inlineCheckbox2" value="option2"></span></div> 图片[p]
								  </label>
								  <label class="checkbox inline">
									<div class="checker" id="uniform-inlineCheckbox3"><span><input type="checkbox" id="inlineCheckbox3" value="option3"></span></div> 跳转[j]
								  </label>
								</div>
							  </div>
							</fieldset>
							...
							<fieldset>
								<div class="control-group rect">
									<label class="control-label" for="inputWarning">缩略图</label>
									<div class="controls">
										<div class="uploader" id="uniform-fileInput"><input class="input-file uniform_on" id="fileInput" type="file"><span class="filename" style="user-select: none;">No file selected</span><span class="action" style="user-select: none;">请选择图片</span></div>
									  </div>
						  		</div>
							</fieldset>
							<fieldset>
							...
							<fieldset>
								<div class="control-group">
									<label class="control-label" for="inputWarning">正文内容</label>
									<div class="controls">
